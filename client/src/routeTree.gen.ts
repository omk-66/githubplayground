...
const UserLayoutDashboardRoute = UserLayoutDashboardImport.update({
  id: '/dashboard',
  path: '/dashboard',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/user/_layout/dashboard': {
      id: '/user/_layout/dashboard'
      path: '/dashboard'
      fullPath: '/user/dashboard'
      preLoaderRoute: typeof UserLayoutDashboardImport
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/user/_layout/dashboard": {
      "filePath": "user/_layout/dashboard.tsx",
      "parent": "/user/_layout"
    },
    "/(website)/_layout/": {
